...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      for(BluetoothDevice pairedDevice : pairedDeveicesList){
          //Se coloca el nombre de dispotivo a conectar
      ...
      button.setOnClickListener(new View.OnClickListener() {
        ...
        //Variables a enviar para encender y apagar el LED
    ...
    //Se crea el metodo del socket de Bluetooth
    private BluetoothSocket createBluetoothSocket (BluetoothDevice device) throws IOException{

        return device.createRfcommSocketToServiceRecord(BTMODULEUUID);
    }
    //Metodo para verificar el Bluetooth
    private void verificarBluetooth(){
        if(btAdapter.isEnabled()){


        }else{
            //Inicia actividad para adaptar el Bluetooth
    ...
    //Es la interaccion con la entrada y salida
    ...
    private class ConnectedThread extends Thread {
        ...
        //Envio de trama
        //Permite enviar comandos a bluetooth
